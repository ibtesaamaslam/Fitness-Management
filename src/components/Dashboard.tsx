...
import { Member, Payment, View, AccessorySale } from '../types';
import { 
  TrashIcon, 
  CloseIcon, 
  LedgerIcon, 
...
const Dashboard: React.FC<DashboardProps> = ({ members, payments, accessorySales = [], onNavigate, onDeletePayment, isUnlocked = false, onUnlockRequest }) => {
